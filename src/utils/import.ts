...
// Convert OpenAI chat format to AsixChatGPT format
export const convertOpenAIToAsixChatGPTFormat = (
...
// Import OpenAI chat data and convert it to AsixChatGPT format
export const importOpenAIChatExport = (openAIChatExport: OpenAIChat[]) => {
  return openAIChatExport.map(convertOpenAIToAsixChatGPTFormat);
};
